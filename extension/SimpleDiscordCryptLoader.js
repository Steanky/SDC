...
chrome.runtime.sendMessage({ type: 'XMLHttpRequest', request: { url: "https://raw.githubusercontent.com/Steanky/SDC/master/SimpleDiscordCrypt.user.js" } }, (result) => { //or chrome.runtime.getURL("SimpleDiscordCrypt.user.js")
	let script = document.createElement('script');
	script.textContent = `
(()=>{
